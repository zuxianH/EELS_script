...
from background_core import BackgroundConfig, config_caption, corrected_display, initial_bounds
...
def render_background(curves, state):
    ...
    with st.container(key="background_layout"):
        ...
        with left, st.container(border=True):
            method = st.selectbox("Method", ["arPLS", "SNIP"], key="bg_method")
        ...
        with right:
            ...
            st.caption("Drag an axis to move it · Shift + drag an axis to scale it "
